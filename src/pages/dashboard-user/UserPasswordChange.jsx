              ...
              <div className="flex flex-col grow pb-20 text-base tracking-wide leading-6 text-neutral-500 max-md:mt-6">
                <div className="flex gap-5 justify-between items-start pt-8 pb-14 pl-8 w-[250px] bg-white rounded-tr-lg max-md:pl-5">
                  ...
                  <div className="flex flex-col mt-2">
                    <div className="flex gap-4 p-2 rounded-lg hover:cursor-pointer transition-transform duration-300 transform hover:scale-105 hover:bg-Primary hover:text-white hover:shadow-lg"
                    ...
                    <div className="flex gap-4 p-2 mt-3 rounded-lg hover:cursor-pointer transition-transform duration-300 transform hover:scale-105 hover:bg-Primary hover:text-white hover:shadow-lg"
                    ...
                    <div className="flex gap-4 mt-3 font-semibold bg-Primary text-white p-2 hover:cursor-pointer rounded-lg "
            ...
            <div className="flex flex-col ml-5 w-[82%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col max-md:mt-6 max-md:max-w-full">
                ...
                <div className="flex flex-col items-center px-16 pt-20 pb-9 bg-white rounded-2xl border border-solid border-slate-100 max-md:px-5 max-md:max-w-full">
                  <div className="flex gap-2 mt-2 max-md:flex-wrap max-md:mt-10">
