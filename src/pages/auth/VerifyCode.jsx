...
const VerifyCode = () => {
  ...
  return (
    ...
    <div className="flex justify-center items-center min-h-screen">
      <div className="flex flex-col md:flex-row items-center bg-white rounded-2xl p-8">
        <form onSubmit={formik.handleSubmit} className="w-full flex flex-col text-xl md:w-1/2">
          <div className="flex items-center justify-center mb-6">
            <img
              src=".//src/assets/logo/Trovka-logo-offcial.png"
              alt="Logo"
              className="h-12 rounded-full"
            />
          </div>
          <p className="text-blue-900 mb-4">
            Please enter it below. A verification code has been sent to {email}.
          </p>
        ...
        <div className="hidden md:flex md:w-1/2 justify-center items-center mt-8 md:mt-0">
          <img src=".//src/assets/icon/otp.png" alt="OTP Icon" className="w-72" />
        </div>
      </div>
    </div>
    </div>
